...
const EditScreen = ({ route }) => {
    ...
    const [value, setValue] = useState(route.params.equID);
    ...
    const [selectedRoom, setSeletedRoom] = useState(route.params.roomID);
            ...
            <Formik
                ...
                onSubmit={async (values) => {
                    ...
                    if(p=="ชื่อไฟล์"){
                        ...
                        dataimage.append('reqID',route.params.reqID)
                        await fetch(`http://localhost:3000/api/user/request`, {
                            ...
                            .then((result) => {
                                if (result.success) {
                                    ...
                                    Alert.alert('แก้ไขเสร็จสิ้น', 'โปรดติดตามสถานะการแจ้งซ่อมของคุณ', [
